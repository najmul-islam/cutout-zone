    ...
    <section className="bg-white py-14">
      <div className="container grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-5">
        <div className="flex flex-col items-center p-3 text-center">
          <span className="mb-3 flex h-24 w-24 items-center justify-center rounded-full bg-[#0979E4] text-5xl text-white">
            <FaGlobeAmericas />
          </span>
          <h6 className="text-2xl font-semibold text-[#0979E4]">
            Bangladesh office
          </h6>
        ...
        <div className="flex flex-col items-center p-3 text-center">
          ...
          <h6 className="text-2xl font-semibold text-[#0979E4]">Call us</h6>
          <a
            href="tel:+880 1884-493280"
            className="transition-all duration-200 hover:text-[#0979E4] hover:underline"
          >
            +880 1884-493280
          </a>
          <a
        ...
        <div className="flex flex-col items-center p-3 text-center">
          ...
          <h6 className="text-2xl font-semibold text-[#0979E4]">Email</h6>
          <a
        ...
        <div className="flex flex-col items-center p-3 text-center">
          ...
          <h6 className="text-2xl font-semibold text-[#0979E4]">Skype</h6>
          <a
