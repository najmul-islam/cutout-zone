    ...
    <section className="py-10">
      <article className="container prose">
        ...
        <p>
          ...
          information we gather. How we usually use your information. How we
          keep your data and image private and store your information. We always
          believe that our privacy policy is well-said and outspoken to
          understand easily.
        </p>
        <p>
          This privacy policy covers all the information that is collected
          through our website when any clients go to our website whether they
          may be personal or non- personal available to us.
        </p>
        <p>
          Please read our privacy policy with full attention and care when you
          enter or go to our website. You are bound to agree with the privacy
          policy and Terms of service set by the incorporated reference by
          CutOut Zone. If you disagree to all of the Terms of privacy, you won’t
          be permitted to use our site or your project may get terminated.
        ...
        <p>
          ...
          survey. Please fill up personal information from which you will see
          below if you like us to get you the best service.
        </p>
        <p>
          The information you have to provide us while filling up a personal
          information form contains the following.
        </p>

        <ul>
          <li className="font-semibold">Full name</li>
          <li className="font-semibold">Username</li>
          <li className="font-semibold">Country</li>
          <li className="font-semibold">Email address</li>
          <li className="font-semibold">Company name (optional)</li>
        ...
        <p>
          ...
          transactional purposes. These companies do not share your personal
          information with other parties without giving specific service of us
        </p>
        ...
        <ul>
          ...
          <li className="font-semibold">To prevent a possible crime</li>
          <li className="font-semibold">
        ...
        <p>
          If any of the materials change is made in the future, you will be
          notified via email which we took from your primary information. You
